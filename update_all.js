...
files.forEach(file => {
    ...
    if (html.includes('tab-1')) {
        html = html.replace(/<div id="tab-1" class="tab-pane fade show p-0 active">[\s\S]*?<\/div>\s*<div id="tab-2"/g, `<div id="tab-1" class="tab-pane fade show p-0 active">\n<div class="row g-4">\n${tab1Items}\n</div>\n</div>\n<div id="tab-2"`);
        html = html.replace(/<div id="tab-2" class="tab-pane fade show p-0">[\s\S]*?<\/div>\s*<div id="tab-3"/g, `<div id="tab-2" class="tab-pane fade show p-0">\n<div class="row g-4">\n${tab2Items}\n</div>\n</div>\n<div id="tab-3"`);
        html = html.replace(/<div id="tab-3" class="tab-pane fade show p-0">[\s\S]*?<\/div>\s*<\/div>\s*<\/div>/g, `<div id="tab-3" class="tab-pane fade show p-0">\n<div class="row g-4">\n${tab3Items}\n</div>\n</div>\n</div>\n</div>`);
    }
    ...
    if (html.includes('<!-- Team End -->')) {
        html = html.replace(/<div class="row g-4">\s*<div class="col-lg-3[\s\S]*?<\/div>\s*<\/div>\s*<\/div>\s*<\/div>\s*<!-- Team End -->/g, 
    ...
    // Testimonial strings can be tricky if they differ slightly, we'll replace them multiple times or use regex carefully
    let testStrs = [
